...
export const config: Config<Assignment> = {
  ...
  form: {
    ...
    description:
      "You have 10 late days in total. For each assignment, you can use at most 2 late days. After submitting the form, you will receive an email showing the result of your request. If your request is approved, we will adjust the due dates on Canvas accordingly.",
    questions: {
      action: {
